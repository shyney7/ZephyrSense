...
Item {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Repeater {
                    model: [
                        { text: "Last 1h", preset: "1h" },
                        { text: "Last 6h", preset: "6h" },
                        { text: "Last 24h", preset: "24h" },
                        { text: "Last 7d", preset: "7d" },
                        { text: "Last 30d", preset: "30d" }
                    ]
    ...
    function loadPreset(preset) {
        ...
        switch (preset) {
            ...
            case "6h": start = new Date(now.getTime() - 6 * 3600000); break
